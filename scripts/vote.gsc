...
init(){maps = undefined;gametypes = undefined;votetime = undefined;winnertime = undefined;	
	...
	*/
	...
	maps = "afghan,bailout,bloc,bog,carnival,chemicalplant,crash,crashtropical,crossfire,derail,estate,estatetropical,favela,favelatropical,firingrange,forgottencity,freighter,fuel,highrise,invasion,karachi,killhouse,nuketown,oilrig,overgrown,quarry,rundown,rust,rustlong,salvage,scrapyard,shipment,shipmentlong,skidrow,storm,strike,subbase,terminal,trailerpark,underpass,vacant,village,wasteland,wetwork,convoy,countdown,crashsnow,creek,dome,dust2,lost,luna2,seatown,stream,summit,tatooine,toujanev2,tunisia,wawcastle,aftertchernobyl,ancient,arbor,backlot,backlotsnow,bakaara,bjwifiaim,bo2carrier,bo2paintball,bo2yemen,boxhjacked,broadcast,brokenroad,burg,c4sminecraft,carentan,carentan2,ccnight";
	...
	*/
	...
	/****************************GAME TYPE SETTINGS*******************************************************************/
	gametypes = "dm,war,sd,sab,dom,koth,ctf,dd,vip,gtnw,oneflag,arena";
